  ...
  if (valuationForm) {
    valuationForm.addEventListener('submit', async (e) => {
      ...
      try {
        ...
        valuationForm.innerHTML = '<div style="text-align:center;padding:2rem;"><div style="font-size:2.5rem;margin-bottom:1rem;">✓</div><h3 style="color:white;font-size:1.5rem;margin:0 0 0.75rem;">Request Received</h3><p style="color:rgba(255,255,255,0.7);">Muhammad Arshad Khan will respond with your free market evaluation within 48 hours.</p></div>';
      } catch (err) {
        if (valuationMsg) {
